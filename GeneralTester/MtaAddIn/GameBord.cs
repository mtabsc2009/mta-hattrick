...
namespace MtaAddIn
{
    ...
    {
        private static localhost.Game m_Game;
        ...
        public GameBord()
        {
            ...
            m_Game = new HattrickGameService.Game();
        ...
        private void LoadWelcome()
        {
            ...
            HatTrick.Views.WinformsView.localhost.Team t = Game.getTeam();
            ...
            switch (((HatTrick.Views.WinformsView.localhost.TrainingType)(Game.getTeam().TeamTrainingType)))
            {
                case (HatTrick.Views.WinformsView.localhost.TrainingType.ATTACK):
                    {
                        attackToolStripMenuItem.Checked = true;
                        break;
                    }
                case (HatTrick.Views.WinformsView.localhost.TrainingType.DEFENCE):
                    {
                        defenceToolStripMenuItem.Checked = true;
                        break;
                    }
                case (HatTrick.Views.WinformsView.localhost.TrainingType.WING):
                    {
                        wingsToolStripMenuItem.Checked = true;
                        break;
                    }
                case (HatTrick.Views.WinformsView.localhost.TrainingType.PLAYMAKING):
                    {
                        playMakingToolStripMenuItem.Checked = true;
                        break;
                    }
                case (HatTrick.Views.WinformsView.localhost.TrainingType.SETPIECES):
                    {
        ...
        {
            Game.ChangeTeamTrainngType((HatTrick.Views.WinformsView.localhost.TrainingType)(int.Parse(attackToolStripMenuItem.Tag.ToString())));
            foreach (ToolStripMenuItem tsi in ((ToolStripMenuItem)((ToolStripMenuItem)sender).OwnerItem).DropDownItems)
            {
                tsi.Checked = false;
            }
        ...
        {
            Game.ChangeTeamTrainngType((HatTrick.Views.WinformsView.localhost.TrainingType)(int.Parse(defenceToolStripMenuItem.Tag.ToString())));
            foreach (ToolStripMenuItem tsi in ((ToolStripMenuItem)((ToolStripMenuItem)sender).OwnerItem).DropDownItems)
            {
                tsi.Checked = false;
            }
        ...
        {
            Game.ChangeTeamTrainngType((HatTrick.Views.WinformsView.localhost.TrainingType)(int.Parse(wingsToolStripMenuItem.Tag.ToString())));
            foreach (ToolStripMenuItem tsi in ((ToolStripMenuItem)((ToolStripMenuItem)sender).OwnerItem).DropDownItems)
            {
                tsi.Checked = false;
            }
        ...
        {
            Game.ChangeTeamTrainngType((HatTrick.Views.WinformsView.localhost.TrainingType)(int.Parse(playMakingToolStripMenuItem.Tag.ToString())));
            foreach (ToolStripMenuItem tsi in ((ToolStripMenuItem)((ToolStripMenuItem)sender).OwnerItem).DropDownItems)
            {
                tsi.Checked = false;
            }
        ...
        {
            Game.ChangeTeamTrainngType((HatTrick.Views.WinformsView.localhost.TrainingType)(int.Parse(setPiecesToolStripMenuItem.Tag.ToString())));
            foreach (ToolStripMenuItem tsi in ((ToolStripMenuItem)((ToolStripMenuItem)sender).OwnerItem).DropDownItems)
            {
                tsi.Checked = false;
            }
